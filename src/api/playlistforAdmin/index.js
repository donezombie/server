...
import { create, index, show, update, destroy, createFromYoutube, CRUDExcerciseToPlaylist } from './controller'
import { schema } from './model'
export playlistadmin, { schema } from './model'

const router = new Router()
const { title, videos, idExcercise, listOptionChoose, typePlaylist } = schema.tree
 ...
 */
router.put('/:id',
  body({ title, videos: [Object], typePlaylist }),
  update)
